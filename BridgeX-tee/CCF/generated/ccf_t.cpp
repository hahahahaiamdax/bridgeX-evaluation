    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    enclave_create_node_args_t* _pargs_in = (enclave_create_node_args_t*)input_buffer;
    enclave_create_node_args_t* _pargs_out = (enclave_create_node_args_t*)output_buffer;
    ...
    if (_pargs_in->node_cert)
        OE_SET_OUT_POINTER(node_cert, _pargs_in->node_cert_size, sizeof(uint8_t), uint8_t*);
    if (_pargs_in->node_cert_len)
        OE_SET_OUT_POINTER(node_cert_len, 1, sizeof(size_t), size_t*);
    if (_pargs_in->service_cert)
        OE_SET_OUT_POINTER(service_cert, _pargs_in->service_cert_size, sizeof(uint8_t), uint8_t*);
    if (_pargs_in->service_cert_len)
        OE_SET_OUT_POINTER(service_cert_len, 1, sizeof(size_t), size_t*);
    if (_pargs_in->enclave_version)
        OE_SET_OUT_POINTER(enclave_version, _pargs_in->enclave_version_size, sizeof(uint8_t), uint8_t*);
    if (_pargs_in->enclave_version_len)
        OE_SET_OUT_POINTER(enclave_version_len, 1, sizeof(size_t), size_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = enclave_create_node(
        _pargs_in->enclave_config,
        _pargs_in->ccf_config,
        _pargs_in->ccf_config_size,
        _pargs_in->node_cert,
        _pargs_in->node_cert_size,
        _pargs_in->node_cert_len,
        _pargs_in->service_cert,
        _pargs_in->service_cert_size,
        _pargs_in->service_cert_len,
        _pargs_in->enclave_version,
        _pargs_in->enclave_version_size,
        _pargs_in->enclave_version_len,
        _pargs_in->start_type,
        _pargs_in->num_worker_thread,
        _pargs_in->time_location);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    enclave_run_args_t* _pargs_in = (enclave_run_args_t*)input_buffer;
    enclave_run_args_t* _pargs_out = (enclave_run_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = enclave_run(
    );
    ...
    uint256_t* value)
{
    ...
    /* Marshalling struct. */
    export_state_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.contract_address = contract_address;
    _args.key = key;
    _args.value = (uint256_t*)value;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(export_state_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(export_state_args_t));
    if (value)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(uint256_t));
    ...
    _pargs_in = (export_state_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    _pargs_out = (export_state_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(value, 1, sizeof(uint256_t));
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_sgx_log_backtrace_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             ccf_fcn_id_oe_syscall_clock_nanosleep_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
